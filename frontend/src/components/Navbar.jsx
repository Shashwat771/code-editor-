...
const Navbar = ({ isGridLayout, setIsGridLayout }) => {
  ...
  return (
    <>
      <div className="navbar flex items-center justify-between px-[100px] h-[80px] glass-strong shadow-elevated animate-slideDown" style={{ position: 'sticky', top: 0, zIndex: 50 }}>
        <div className="logo">
        ...
        <div className="links flex items-center gap-6">
          ...
          <button onClick={logout} className='btnBlue !bg-gradient-to-r !from-red-500 !to-red-600 min-w-[120px] ml-2'>Logout</button>
          <Avatar onClick={() => { toggleClass(".dropDownNavbar", "hidden") }} name={data ? data.name : ""} size="40" round="50%" className='cursor-pointer ml-2 transition-transform hover:scale-110 ring-2 ring-purple-500/30' />
        </div>

        <div className='dropDownNavbar hidden absolute right-[60px] top-[80px] glass-strong shadow-elevated p-4 rounded-xl w-[180px] animate-slideDown'>
